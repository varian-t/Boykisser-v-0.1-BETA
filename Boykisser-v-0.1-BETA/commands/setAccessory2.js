...
module.exports = {
  ...
  run: async ({ interaction }) => {
    ...
    if (user.currentAccessory2?.[selectedKisser]) {
      return await interaction.reply({
        content: `Accessory slot 2 for **${selectedKisser}** is already occupied. Use /removeaccessory2 to free the slot first.`,
        ephemeral: true,
      });
    }
