...
const DefaultCommands_1 = __importDefault(require("../utils/DefaultCommands"));
class CommandHandler {
    ...
    async readFiles() {
        const defaultCommands = (0, get_all_files_1.default)(path_1.default.join(__dirname, "./default-commands"));
        ...
        for (let fileData of defaultCommands) {
            ...
            if (del ||
                (defaultCommandValue &&
                    ...
                    this._instance.defaultCommand.disabledCommands.includes(defaultCommandValue)) ||
    ...
    getValidations(folder) {
        if (!folder)
            return [];
        const validations = (0, get_all_files_1.default)(folder).map((fileData) => fileData.fileContents);
        return validations;
    }
}
